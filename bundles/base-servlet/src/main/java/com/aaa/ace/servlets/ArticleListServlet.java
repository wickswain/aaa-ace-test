 ...
 * Passes the input from Ajax call to service and returns back the JSON search result.
 */
...
@Properties(value = {
        ...
        @Property(name = "service.description", 
                value = "com.aaa.ace.services AAA Article Servlet") })
public class ArticleListServlet extends SlingAllMethodsServlet {
    ...
    protected void activate(ComponentContext ctx) {
        ...
        String maxage = PropertiesUtil.toString(properties.get(RESPONSE_CACHE_CONTROL_MAX_AGE),
                CACHE_HEADER_DEFAULT_MAX_AGE);
    ...
    protected final void doGet(final SlingHttpServletRequest request,
        ...
        String numOfResult = isValid(numOfResultInput) ? numOfResultInput : DEFAULT_NUM_OF_RESULT;
        ...
        try {
            ...
            error.put("message",
                    "Sorry, something went wrong, "
                            + "if issue persist please contact site adminstrator.");
            if (e.getCause() != null) {
    ...
    private boolean isValid(String input) {
        ...
        // The input we are expecting should not have < or > to prevent script
        // injection.
